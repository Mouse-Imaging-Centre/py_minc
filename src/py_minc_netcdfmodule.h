#ifndef Py_PY_MINC_NETCDFMODULE_H
#define Py_PY_MINC_NETCDFMODULE_H
#ifdef __cplusplus
extern "C" {
#endif
...
/* Get variable shape */
#define PyNetCDFVariable_GetShape_RET long *
...
/* Create a NetCDF object from an existing open file */
#define PyNetCDFFile_from_id_RET PyNetCDFFileObject *
#define PyNetCDFFile_from_id_PROTO Py_PROTO((int id))
#define PyNetCDFFile_from_id_NUM 22

/* Total number of C API pointers */
#define PyNetCDF_API_pointers 23



#ifdef _PY_MINC_NETCDF_MODULE
...
static PyNetCDFFile_from_id_RET PyNetCDFFile_from_id PyNetCDFFile_from_id_PROTO; 
...
#define PyNetCDFFile_from_id \
  (*(PyNetCDFFile_from_id_RET (*)PyNetCDFFile_from_id_PROTO) \
  PyNetCDF_API[PyNetCDFFile_from_id_NUM])
